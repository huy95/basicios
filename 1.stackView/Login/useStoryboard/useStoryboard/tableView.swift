...
class tableView: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let eachData = getdata[indexPath.row] as Dog
        cell.textLabel?.text = eachData.name
        cell.detailTextLabel?.text = eachData.title
//        if let labelName = cell.viewWithTag(10) as? UILabel{
//            labelName.text = eachData.name
//        }
//        if let labeltitle = cell.viewWithTag(11) as? UILabel{
//            labeltitle.text = eachData.title
//        }
        return cell
    }
